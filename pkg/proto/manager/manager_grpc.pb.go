...
const (
	Manager_IngestRepository_FullMethodName            = "/manager.Manager/IngestRepository"
...
type ManagerClient interface {
	IngestRepository(ctx context.Context, in *IngestRepositoryRequest, opts ...grpc.CallOption) (*IngestRepositoryResponse, error)
	// 启动注册方法
...
func (c *managerClient) IngestRepository(ctx context.Context, in *IngestRepositoryRequest, opts ...grpc.CallOption) (*IngestRepositoryResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(IngestRepositoryResponse)
	err := c.cc.Invoke(ctx, Manager_IngestRepository_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type ManagerServer interface {
	IngestRepository(context.Context, *IngestRepositoryRequest) (*IngestRepositoryResponse, error)
	// 启动注册方法
...
func (UnimplementedManagerServer) IngestRepository(context.Context, *IngestRepositoryRequest) (*IngestRepositoryResponse, error) {
	return nil, status.Errorf(codes.Unimplemented, "method IngestRepository not implemented")
}
...
func _Manager_IngestRepository_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(IngestRepositoryRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(ManagerServer).IngestRepository(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: Manager_IngestRepository_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(ManagerServer).IngestRepository(ctx, req.(*IngestRepositoryRequest))
	}
...
var Manager_ServiceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		{
			MethodName: "IngestRepository",
			Handler:    _Manager_IngestRepository_Handler,
		},
		{
			MethodName: "Register",
